  ...
  return (
    <div className="bg-Snow w-full h-full p-10 rounded-lg flex flex-col lg:flex-row justify-between items-center font-[Suwannaphum] mt-2 mx-auto shadow-sm ">
      ...
      <div className="lg:w-1/2 flex flex-wrap justify-center items-center mt-10 lg:mt-0 gap-4">
        <img src={hero3} alt="Travel 1" className="rounded-[10px] border-[#faa834] border-2 shadow-md w-1/3 max-w-[120px] md:h-90 object-cover aspect-[9/16]" />
        <img src={hero2} alt="Travel 2" className="rounded-[10px] border-[#faa834] border-2 shadow-md w-1/3 max-w-[140px] md:h-110 object-cover aspect-[9/16]" />
        <img src={hero4} alt="Travel 3" className="rounded-[10px] border-[#faa834] border-2 shadow-md w-1/3 max-w-[120px] md:h-90 object-cover aspect-[9/16]" />
      </div>
